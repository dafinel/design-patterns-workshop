...
{
    public class CustomUsersPage : UsersPage
    {
        public CustomUsersPage(IWebDriver webDriver) : base(webDriver)
        {
        }
        ...
        public override void Load()
        {
            ...
            foreach (var row in rows)
            {
                ...
                var user = new UserInfo
                {
                    ...
                    City = columns[6].Text,
                    PostalCode = columns[7].Text,
                    State = columns[8].Text,
                    Country = columns[9].Text
                };
                Users.Add(user);
            }
        }
        ...
        public override bool IsFirstUser(UserInfo user)
        {
            ...
            return firstUser != null && firstUser.First == user.First && firstUser.Last == user.Last && firstUser.PostalCode == user.PostalCode;
        } 
    }
}